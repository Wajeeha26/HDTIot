...
class UserAPIViewSet(APIView):
    ...
    def put(self, request):
        ...
        """
        # Get logs Extras
        extras = log_request(request, logger=logger, api_name=USER_API.get("PUT").get("api_name"))
        ...
        try:
            ...
            request.user.update_name(request.data.get("first_name", request.user.first_name),
    ...
    def delete(self, request, uid=None):
        # Get logs Extras
        extras = log_request(request, logger=logger, api_name=USER_API.get("DELETE").get("api_name"))
        ...
        try:
            ...
            return api_success_response(status_code=status.HTTP_200_OK, message="User Deleted",
                                        data={}, extras=extras)
