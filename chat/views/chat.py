...
class Chat(View):
    ...
    def get(self, request, uid):
        ...
        try:
            ...
            chats = UserChat.objects.filter(user=user).values("id", "prompt", "response", "created_at")
    ...
    def post(self, request):
        ...
        try:
            ...
            user_chat = UserChat.objects.create(user=user, prompt=prompt, response=response)
